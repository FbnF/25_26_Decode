...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2766.443859989757; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2229.1895427663035; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1300.8690711471293; // x position of the perpendicular encoder (in tick units)
    }
