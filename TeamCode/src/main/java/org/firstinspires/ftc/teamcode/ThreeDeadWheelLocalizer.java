...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2758.2335247036754; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2230.09905513691; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1369.3010242364985; // x position of the perpendicular encoder (in tick units)
    }
