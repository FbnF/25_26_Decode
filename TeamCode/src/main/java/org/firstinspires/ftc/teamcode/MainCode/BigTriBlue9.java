...
@Autonomous(name = "BigTriBLUE9", group = "BigTriBlue")
public class BigTriBlue9 extends LinearOpMode {
    ...
    private static final double SHOOTER_Vel_2 = 1210;
    ...
    public void runOpMode() {
        ...
        Action all = drive.actionBuilder(startPose)
                ...
                .splineToLinearHeading(new Pose2d(-8.5, -24,Math.toRadians(270)),Math.toRadians(260))
                ...
                .strafeToLinearHeading(new Vector2d(-30, -11.5), Math.toRadians(235))
                // Shooter runs
                .stopAndAdd(new  ShooterAndFeederCombined(
                        shooter, intake,
                        feed, side, distance,
