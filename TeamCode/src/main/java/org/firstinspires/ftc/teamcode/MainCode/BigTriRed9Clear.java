...
public class BigTriRed9Clear extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(-57, 36, Math.toRadians(90));//Pose2d startPose = new Pose2d(-57, 36, Math.toRadians(0));//Pose2d startPose = new Pose2d(-57, 36, Math.toRadians(90)); //-48, 48, Math.toRadians(135));
...
//clear
                ...
                .strafeToLinearHeading(new Vector2d(1, 58), Math.toRadians(180))
                .waitSeconds(0.15)
