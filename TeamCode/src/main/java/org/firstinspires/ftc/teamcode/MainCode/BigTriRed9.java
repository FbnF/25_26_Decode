...
public class BigTriRed9 extends LinearOpMode {
    ...
    private static final double SHOOTER_Vel_2 = 1240;
    private static final double SHOOTER_Vel_3 = 1180;
    ...
    private static final double SHOOT_TIME_2 = 5;
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(-57, 36, Math.toRadians(90));//Pose2d startPose = new Pose2d(-57, 36, Math.toRadians(0));//Pose2d startPose = new Pose2d(-57, 36, Math.toRadians(90));//Pose2d startPose = new Pose2d(-48, 48, Math.toRadians(135));
        ...
        Action all = drive.actionBuilder(startPose)
                ...
                .strafeToLinearHeading(new Vector2d(-22, 20), Math.toRadians(130))

                // Shooter runs
                .stopAndAdd(new  ShooterAndFeederCombined(
                        shooter, intake,
                        feed, side, distance,
                        SHOOTER_Vel_3, sidePower,
...
//clear
                .strafeToLinearHeading(new Vector2d(-20, 20), Math.toRadians(138))
                // Shooter runs
                .stopAndAdd(new  ShooterAndFeederCombined(
                        shooter, intake,
                        feed, side, distance,
                ...
                .splineToLinearHeading(new Pose2d(18.5, 24,Math.toRadians(97)),Math.toRadians(97))
                .stopAndAdd(setMotorVel(shooter, SHOOTER_Vel))
                .lineToY(52)
                .lineToY(45)
                .stopAndAdd(setMotorPower(intake, 0.0))
                ...
                .strafeToLinearHeading(new Vector2d(-31, 11.5), Math.toRadians(127))
                // Shooter runs
                .stopAndAdd(new  ShooterAndFeederCombined(
                        shooter, intake,
                        feed, side, distance,
                        SHOOTER_Vel_2, sidePower,
                        WAIT_TIME,SHOOT_TIME_2))
