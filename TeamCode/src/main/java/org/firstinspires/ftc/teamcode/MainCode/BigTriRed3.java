...
@Autonomous(name = "BigTriRED3", group = "BigTriRed")
public class BigTriRed3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(-57, 36, Math.toRadians(90));//Pose2d startPose = new Pose2d(-57, 36, Math.toRadians(0));//(-57, 36, Math.toRadians(90));//Pose2d startPose = new Pose2d(-48, 48, Math.toRadians(135));
        ...
        Action all = drive.actionBuilder(startPose)
                ...
                .strafeToLinearHeading(new Vector2d(-29, 11.5), Math.toRadians(115))
                // Shooter runs
